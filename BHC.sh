...
echo $yellow
figlet -f future "  BLACK HAT CYBER"
echo
echo $red"##########################$green" WELCOME "$red###########################"
echo
...
echo $indigo"=============================================================="
echo
echo $white "╭─"$yellow"BlackHatCyber"$cyan" ~/T34M BHC"$white
read -p " ╰─$ "  apaan
echo
if [ $apaan = "A" ] || [ $apaan = "a" ]
then
...
echo
echo
toilet -f future "Deface BLACK HAT CYBER" | lolcat
echo
...
echo $green "╭─"$blue"BlackHatCyber"$cyan" ~/T34M BHC"$white
read -p " ╰─$ "  target
echo
echo $red "Masukan Script!!! "
echo $green "╭─"$blue"BlackHatCyber"$cyan" ~/Nama SC Harus(index.html)"$white
read -p " ╰─$ "  script
...
echo
echo "Masukan Script !!!!"
echo $white "╭─"$green"BlackHatCyber"$cyan" ~/T34M BHC"$white                               
read -p " ╰─$ " script
echo
echo
...
echo $red"##########################$green" WELCOME "$red###########################"
echo $green"Author  : BHC-FAKE			"
echo $purple"Gthub   : https://github.com/BHC-FAKE"
echo $white"Planet  :  MARS                     "
echo
echo $yellow"                          THANKS TO :"
echo
echo $cyan"[+] BHC•O²N¦Mr.Rexx¦√  "
echo $cyan"[+] BHC•HΔ©Keyt$⁩- "
echo $cyan"[+] BHC-Poker & All Member [B.H.C] "
echo $red"##########################$green" WELCOME "$red###########################"
